...
.pull.left[.pad1[.font2[
Kunoichi theme (incomplete)
```{r, eval=TRUE, message = FALSE}
theme_kunoichi <- function(...) {
  theme_grey(...) %+replace%
  theme( 
    plot.background = element_rect(fill = "#BA68C8", colour = "#BA68C8"),
    panel.background = element_rect(fill = "#562457", colour = "#562457"),
    legend.background = element_rect(fill = "#BA68C8", colour = "#BA68C8"),
...
.column.bg-main1[.content.vtop.center[
.pull.left[.pad1[.font2[
Animation as faceting over time...
```{r, eval=FALSE, message = FALSE}
# Instead of this:
# b + facet_wrap(facets = vars(Time))

# Do this:
b + transition_time(time = Time)
```
...
.column.bg-main1[.content.vtop.center[
.pull.left[.pad1[.font2[
You can animate different things...
```{r, eval=FALSE, message = FALSE}
c <- a + 
  theme_kunoichi() +
  transition_states(states = Series) 
...
.column.bg-main1[.content.vtop.center[
.pull.left[.pad1[.font2[
Try a reveal transition?
```{r, eval=FALSE, message = FALSE}
d + transition_reveal(date)
```
